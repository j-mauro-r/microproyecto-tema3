"""
Post-hoc calibration via CalibratedClassifierCV (isotonic) sobre el val set (anio 2022-2023).
...
Output: model/xgb_clasico_calibrated.pkl, model/lgbm_clasico_calibrated.pkl
        Cada pkl es un dict: {model, features, calibrated, method, brier_before, brier_after, best_threshold}
"""
import os
import pickle
