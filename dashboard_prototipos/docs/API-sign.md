...
La API solo puede depender de `ChampionOutput` normalizado. No puede contener branching del tipo `if materialized` / `if executable`, ni importar JSON PR #12, XGBoost, pickle o paquetes de modelo.
